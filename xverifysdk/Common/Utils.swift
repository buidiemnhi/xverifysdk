...
/// This function normalize the Vietnamese charaters
/// @param string: a string includes Vietnamese characters
/// @return: a string included normalized Vietnamese charaters
...
/// This function extract Vietnamese province/city
/// @param string: a Vietnamese address string
/// @return: a string includes only province/city
public func extractVietnameseProvince(_ address: String?) -> String? {
...
public func stringIsNullOrEmpty(_ string: String?) -> Bool {
    string == nil || string == "" || string == "NULL" || string == "null"
}
