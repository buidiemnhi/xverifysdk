...
public class PACEInfo : SecurityInfo {
        ...
        switch try getKeyAgreementAlgorithm() {
            case "DH":
                ...
                guard dhKey != nil else {
                    throw NfcEIdReaderError.InvalidDataPassed("Unable to create DH mapping key")
                }
                defer{ DH_free( dhKey ) }
            ...
            case "ECDH":
                ...
                guard let ecKey = EC_KEY_new_by_curve_name(parameterSpec) else {
                    throw NfcEIdReaderError.InvalidDataPassed("Unable to create EC mapping key")
                 }
            ...
            default:
                throw NfcEIdReaderError.InvalidDataPassed("Unsupported agreement algorithm")
        }
    ...
    public static func getParameterSpec(stdDomainParam : Int) throws -> Int32 {
        switch (stdDomainParam) {
            ...
            default:
                throw NfcEIdReaderError.InvalidDataPassed( "Unable to lookup p arameterSpec - invalid oid" )
        }
    }
    ...
    public static func toMappingType( oid : String ) throws -> PACEMappingType {
        ...
        throw NfcEIdReaderError.InvalidDataPassed( "Unable to lookup mapping type - invalid oid" )
    }
    ...
    public static func toKeyAgreementAlgorithm( oid : String ) throws -> String {
        ...
        throw NfcEIdReaderError.InvalidDataPassed( "Unable to lookup key agreement algorithm - invalid oid" )
    }
    ...
    public static func toCipherAlgorithm( oid : String ) throws -> String {
        ...
        throw NfcEIdReaderError.InvalidDataPassed( "Unable to lookup cipher algorithm - invalid oid" )
    }
    ...
    public static func toDigestAlgorithm( oid : String ) throws -> String {
        ...
        throw NfcEIdReaderError.InvalidDataPassed( "Unable to lookup digest algorithm - invalid oid" )
    ...
    public static func toKeyLength( oid : String ) throws -> Int {
        ...
        throw NfcEIdReaderError.InvalidDataPassed( "Unable to get key length - invalid oid" )
    }
